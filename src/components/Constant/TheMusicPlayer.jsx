...
import timeToMinute from "../hooks/TimeToMinute";
...
function TheMusicPlayer(props) {
  ...
  function changeProgressBar(e) {
    ...
    if (audio.currentTime) audio.currentTime = perTime;
  }
        ...
        <div className="aside-music">
          <div className="music-avatar" onClick={openMusicDetail}>
            <img
              src={
                thisSong.cover ||
                "https://i.loli.net/2021/11/03/CM6T9AamqOUgRzb.png"
              }
              alt="网易云音乐"
            ></img>
          </div>
          <div className="music-detail">
            ...
            <p className="progress-time">
              {hasPlayedTime}/{songDuration || "00:00"}
            </p>
          </div>
        </div>
