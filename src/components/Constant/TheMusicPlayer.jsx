...
function TheMusicPlayer(props) {
    ...
    return (
        <div className="player-main">
            <div id="progress" className="progress" onClick={changeProgressBar}>
            ...
            <div className="player">
                <div className="aside-music">
                    <div className="music-avatar" onClick={openMusicDetail}>
                        <img src={thisSong.cover || "https://i.loli.net/2021/11/03/CM6T9AamqOUgRzb.png"}
                             alt="网易云音乐"></img>
                    </div>
                ...
                <div className="music-main">
                    <span>
                        <svg onClick={lastSong} t="1635406948422" viewBox="0 0 1024 1024" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" p-id="3036" width="20" height="20"><path
                            ...
                            fill="#231815" p-id="3037"></path></svg>
                    </span>
                    <span onClick={controlPlay}>
                        {
                            ifPlay
                                ? <svg t="1635671484216" className="icon" viewBox="0 0 1024 1024" version="1.1"
                                       xmlns="http://www.w3.org/2000/svg" p-id="3753" width="30" height="30">
                                    <path
                                ...
                                : <svg t="1635406901217" viewBox="0 0 1024 1024" version="1.1"
                                       xmlns="http://www.w3.org/2000/svg" p-id="2534" width="30" height="30">
                                    <path
                    ...
                    <span>
                        <svg onClick={nextSong} t="1635406983991" viewBox="0 0 1024 1024" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" p-id="3681" width="20" height="20"><path
                            ...
                            fill="#231815" p-id="3682"></path></svg>
                    </span>
                </div>
